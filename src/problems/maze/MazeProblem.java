...
public class MazeProblem implements SearchProblem {
    ...
    public State applyAction(State state, Action action) {
        ...
        if (mazeAction == MazeAction.EAT) {
            //********************************
            // TO DO (1)
            applied = new MazeState(mazeState.getY(), mazeState.getX(), mazeState.getNumBites(), true);
            return applied;
        }
        //********************************
        ...
        switch (mazeAction) {
            case LEFT:
                newPosX--;
                System.out.print("Mueve left\n");
                break;
            case RIGHT:
                newPosX++;
                System.out.print("Mueve right\n");
                break;
            case UP:
                newPosY--;
                System.out.print("Mueve up\n");
                break;
            case DOWN:
                newPosY++;
                System.out.print("Mueve down\n");
                break;
        }
        
        applied = new MazeState(newPosY, newPosX, mazeState.getNumBites(), mazeState.getHasEaten());
        

        //********************************
        // TO DO (2)
        int newCell = maze.cells[newPosY][newPosX];
        // If the new position is empty or cheese, or is a Wood but we have bites remaining...
