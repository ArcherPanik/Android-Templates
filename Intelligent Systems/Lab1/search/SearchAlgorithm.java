...
public abstract class SearchAlgorithm {
    ...
    /**
     * Return the successors of a given node. It is necessary if besides the
     * states, some other information, such as actions, costs, etc., is needed.
    ...
    public ArrayList<Node> getSuccessors(Node node) {
        ...
        for (Action action : actions) {
            ...
            try {
                ...
                System.out.print("-------------------" + costAction + "\n\n");
                newNode.setCost(node.getCost() + costAction);
                System.out.print("-------------------" + newNode.getCost() + "\n\n");
                ...
                System.out.print("NullPointerException en clase SearchAlgorithm!!!!!\n\n ");
            }
        }
        expandedNodes++;
        return successors;
